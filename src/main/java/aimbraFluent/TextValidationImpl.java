...
import aimbraFluent.interfaces.ITextValidation;
...
public class TextValidationImpl implements ITextValidation {
    ...
    @Override
    public boolean isEmpty(String value, String messageError) {
        if (isEmpty(value)) throw new BadRequestException(messageError);
        return false;
    }
